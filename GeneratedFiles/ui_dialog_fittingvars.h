...
public:
    ...
    void setupUi(QDialog *dialog_fittingvars_class)
    {
        ...
        dialog_fittingvars_class->resize(432, 291);
        ...
        layoutWidget->setGeometry(QRect(0, 250, 431, 33));
        ...
        lineAlphaConn->setGeometry(QRect(90, 120, 61, 22));
    ...
    void retranslateUi(QDialog *dialog_fittingvars_class)
    {
        ...
        label->setText(QApplication::translate("dialog_fittingvars_class", "Target function:       f = chi\302\262 + \316\261 \302\267 connectivity  + \316\262 \302\267 compactness", 0));
